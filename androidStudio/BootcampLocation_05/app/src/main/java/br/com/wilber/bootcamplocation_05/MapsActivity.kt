package br.com.wilber.bootcamplocation_05
...
class MapsActivity : AppCompatActivity(),
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        //sidney LatLng(-34.0, 151.0)
        //new  york LatLng(40.73, -73.99)
    ...
    private fun createLocationRequest(){
        ...
        locationRequest.interval = 10000  //1 segundo
        locationRequest.fastestInterval = 5000  //0.5 segundo
        locationRequest.priority = LocationRequest.PRIORITY_HIGH_ACCURACY //prioridade alta
    ...
    //por causa do consumo de bateria
