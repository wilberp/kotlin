...
import br.com.wilber.applicationcontentprovider.database.NotesDatabaseHelper.Companion.DESCRIPTION_NOTES
...
class NotesDetailFragment: DialogFragment(), DialogInterface.OnClickListener {
    ...
    private lateinit var noteEditDecription: EditText
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        noteEditDecription = view.findViewById(R.id.note_edt_description) as EditText
        ...
        if (arguments !=null && arguments?.getLong(EXTRA_ID) != 0L){
            ...
            if(cursor?.moveToNext() as Boolean){
                ...
                noteEditDecription.setText(cursor.getString(cursor.getColumnIndex(DESCRIPTION_NOTES)))
            }
            cursor.close()
        }
        return AlertDialog.Builder(activity as Activity)
            ...
            .setNegativeButton("Caancelar", this)
            .create()
    }
    ...
    override fun onClick(dialog: DialogInterface?, which: Int) {
        ...
        values.put(DESCRIPTION_NOTES, noteEditDecription.text.toString())
